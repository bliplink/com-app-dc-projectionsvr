...
@Service("queryProjectedExecutionHistory")
public class QueryProjectedExecutionHistoryHandler extends ContentHandler {
    @Autowired
    ...
    public Map<String, Object> handle(String topic, Message message, String content,
        ...
        try {
            OrderProjectionService.HistoryResult result = projectionService.queryExecutionHistory(content);
            ...
            logger.error("query projected execution history failed", e);
